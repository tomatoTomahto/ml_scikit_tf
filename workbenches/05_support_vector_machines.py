...
# SVM classifier will separate classes while staying as far away from the closest
# training instances as possible. In other words, it will fit the widest street
# between the classes
...
# Some datasets are not inherently linearly separateable, see how adding a feature
# with a power (ie. x to x^2) creates a linearly separatable dataset
...
# Let's try this with the moons dataset
...
# We can create a pipline that adds polynomial features, scales features, and does a linear SVC
...
# Adding many degrees of polynomials explodes the # of features, we can mimik this
# with a 'kernel trick' in SVC
from sklearn.svm import SVC

# degree sets the max degree of the polynomial, and coef0 indicates how influential higher degrees are
...
# SVR can also be used for non-linear regression using the poly kernel trick
np.random.seed(42)
m = 100
